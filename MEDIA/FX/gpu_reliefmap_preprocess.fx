...
//	return float4(tex2D(ReliefSampler,input.TexCoord).xxx, 1);
	return float4(tex2D(ResultSampler,input.TexCoord).xxx, 1);
	return float4(r,r,r,1);
}

float4 viewtexture1( VS_OUTPUT input ) : COLOR
{
...
technique viewtexture
{
	...
	{          
		...
		PixelShader  = compile ps_2_0 viewtexture1( ); 
	}
}
